      ...
      featured: [
        {
          ...
          imageAlt: 'Livros personalizados para meninas.',
        },
        {
          name: 'Histórias de Princesa',
          href: '#',
          imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/mega-menu-category-02.jpg',
          imageAlt: 'Livros com histórias de princesas personalizadas.',
        },
      ],
      sections: [
        {
          ...
          name: 'Aventura',
          items: [
            { name: 'Aventuras Mágicas', href: '#' },
            { name: 'Viagens Imaginárias', href: '#' },
            { name: 'Mistérios e Enigmas', href: '#' },
            { name: 'Amizades Incríveis', href: '#' },
            { name: 'Explorações', href: '#' },
            { name: 'Descobertas', href: '#' },
            { name: 'Superação', href: '#' },
            { name: 'Coragem', href: '#' },
            { name: 'Ver Todas', href: '#' },
          ],
        },
        {
          ...
          name: 'Fantasia',
          items: [
            { name: 'Mundo dos Sonhos', href: '#' },
            { name: 'Fadas e Duendes', href: '#' },
            { name: 'Castelos Encantados', href: '#' },
            { name: 'Animais Falantes', href: '#' },
            { name: 'Floresta Mágica', href: '#' },
            { name: 'Contos de Fada', href: '#' },
          ],
        },
        {
          id: 'temas',
      ...
      featured: [
        {
          ...
          imageAlt: 'Livros personalizados para meninos.',
        },
        {
          name: 'Histórias de Herói',
          href: '#',
          imageSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/category-page-02-image-card-06.jpg',
          imageAlt:
            'Livros com histórias de heróis personalizadas.',
        },
      ],
      sections: [
        {
          ...
          name: 'Aventura',
          items: [
            { name: 'Aventuras Épicas', href: '#' },
            { name: 'Missões Perigosas', href: '#' },
            { name: 'Explorações', href: '#' },
            { name: 'Desafios', href: '#' },
            { name: 'Coragem', href: '#' },
            { name: 'Amizade', href: '#' },
